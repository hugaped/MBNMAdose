...
#'
#' Used to fit B-splines and natural cubic
#' splines\insertCite{perperoglu2019}{MBNMAdose}.
#'
#' @param type The type of spline. Can take `"bs"` (\href{https://mathworld.wolfram.com/B-Spline.html}{B-spline}),
#'   or `"ns"` (\href{https://mathworld.wolfram.com/CubicSpline.html}{natural cubic spline}).
