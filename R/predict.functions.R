...
#'
#' @details
#' Only *either* `E0.data` *or* `E0.estimate` need to be specified as arguments (not both).
#'
...
#' lead to fitting a smooth dose-response curve (provided `n.cut` is sufficiently high).
#'
...
predict.MBNMA <- function(mbnma, max.doses=NULL, n.doses=15, exact.doses=NULL,
  ...
  output <- list("predicts"=predict.result,
                 "likelihood"=mbnma$model.arg$likelihood, "link"=mbnma$model.arg$link)
