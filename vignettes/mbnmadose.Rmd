...
As several NMA models will need to be run for each treatment comparison to split, this function can take some time to run, and results for it are therefore not shown in this vignette.
