...
```{r}
ed50.priors <- list(ed50 = c("dnorm(100, 0.0025) T(0,)", # Prior for Celebrex
                             "dnorm(20, 0.01) T(0,)", # Prior for Etoricoxib
                             "dnorm(50, 0.0025) T(0,)", # Prior for Lumiracoxib
                             "dnorm(500, 0.0004) T(0,)", # Prior for Naproxcinod
                             "dnorm(500, 0.0004) T(0,)", # Prior for Naproxen
                             "dnorm(35, 0.04) T(0,)", # Prior for Rofecoxib
                             "dnorm(200, 0.0004) T(0,)", # Prior for Tramadol
                             "dnorm(4, 0.04) T(0,)" # Prior for Valdecoxib
                             ))
